...
public class RobotContainer {
  ...
  private final TriggerBinding TriggerForShooter = new TriggerBinding(m_stick_Control, Constants.trigger_l);
  ...
  //private final GeneratorSwitch m_generatorSwitch = new GeneratorSwitch(m_lift, m_controlPanel, m_stick_Control);
  ...
  private final AutonomousGroup m_autonomousGroup = new AutonomousGroup(m_shooter, m_drive);
  ...
  private void configureButtonBindings() {
    //TriggerForShooter.whenActive(m_shooterWithJoystick);
